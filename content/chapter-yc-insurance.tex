...
% 
% Under the previous short-rate models' specification, arbitrage-free prices of zero-coupon bonds can be expressed analytically.
...
\end{equation}
where $\FF$ is the natural filtration associated to the short-rate process $X$. %which is a short-rate process.
...
\end{equation}
Given that $t_{0}=0$, the integral term  in equation \label{ZC_price} becomes 
\begin{equation}
\label{Intb}
